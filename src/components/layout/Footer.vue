 <template>
  <footer class="app-footer">
    <div class="row">
      <div class="col-md-4">
        <img class="footer-logo" src="/public/assets/logo/logo.png" alt="" />
  ...
  <div class="footer-bottom text-center fs-13 p-3">
    Copyright <strong>© KAPPI</strong>. All rights reserved.
  </div>
</template>
