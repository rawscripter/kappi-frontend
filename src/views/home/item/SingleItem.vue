<template>
    <div class="single-item shadow d-flex">
        ...
        <div class="single-item__info">
            ...
            <div
                class="single-item__info-descriptions d-flex justify-content-start align-items-center"
            >
            ...
            <div
                class="single-item__info-actions d-flex justify-content-between align-items-end flex-column-sm"
            >
